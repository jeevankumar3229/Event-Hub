...
namespace WindowsApplicationProject
{
    public partial class EventSendingForm : Form
    {
        ...
        public void AddKeyValueTextField()
        {
            ...
            key.Location = new System.Drawing.Point(300, 210 + rowcount * 30);

            label.Name = "labelname";
           
            label.Text = ":";
            
            label.Location= new System.Drawing.Point(425, 210 + rowcount * 30);

            value.Name = "value";

            value.Size = new Size(100, 30);

            value.Location = new System.Drawing.Point(450, 210 + rowcount * 30);
